...
public class Log_in_server {
    ...
    public  void log_entry( ) throws IOException {
        Log_in_server server = new Log_in_server();
        server.startServer();
    ...
    public void startServer() throws IOException {
        ...
        serverChannel.bind(new InetSocketAddress(2021));  // 绑定服务器地址和端口
...
//      
       ...
       // returnMessage("Register ok", clientChannel);
            int result = operation.select_query(parts[0],parts[1]);//result is used for client notify themself,make it is accessable to connect to chatserver
	    returnMessage(String.valueOf(result), clientChannel);
